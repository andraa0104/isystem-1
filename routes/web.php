...
Route::post('/login-simple', [SimpleAuthController::class, 'login']);

Route::post('/heartbeat-simple', [SimpleAuthController::class, 'heartbeat']);

Route::match(['get', 'post'], '/logout-simple', [SimpleAuthController::class, 'logout']);

Route::get('/online-users', [SimpleAuthController::class, 'onlineUsers']);

Route::get('/ping', [SimpleAuthController::class, 'ping']);

Route::get('/ping-db', [SimpleAuthController::class, 'pingDb']);
...
Route::get('marketing/purchase-order-in/tracking', [PurchaseOrderInController::class, 'track'])
    ->name('marketing.purchase-order-in.track');
...
Route::get('pembelian/purchase-order/partial-ir', [PurchaseOrderController::class, 'partialIr'])
