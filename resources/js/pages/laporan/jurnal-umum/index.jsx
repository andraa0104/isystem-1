...
const buildPrintUrl = (query) => {
    ...
    params.set('sortBy', query.sortBy ?? 'Tgl_Jurnal');
    params.set('sortDir', query.sortDir ?? 'desc');
    return `/laporan/jurnal-umum/print?${params.toString()}`;
};
...
export default function JurnalUmumIndex() {
    const {
        initialQuery = {},
        periodOptions = [],
        defaultPeriod = '',
    ...
    const loadDetailsIfNeeded = async (kodeJurnal) => {
        if (!kodeJurnal) return;
        if (detailMap[kodeJurnal] || detailLoading[kodeJurnal]) return;

        setDetailLoading((s) => ({ ...s, [kodeJurnal]: true }));
        setDetailError((s) => ({ ...s, [kodeJurnal]: '' }));
        try {
            const params = new URLSearchParams();
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <Input
                            ...
                            placeholder="Cari kode jurnal/voucher/remark/kode akun/nama akun..."
                    ...
                    <table className="min-w-full text-sm text-left">
                        ...
                        <tbody>
                            ...
                            {rows.map((r, idx) => {
                                ...
                                const open = Boolean(openMap[kodeJurnal]);
